...
class T_log_kunci extends CI_Model
{
	var $table = 't_log_kunci';
	var $column_search = ['t_log_kunci.bulan','t_log_kunci.tahun','m_user.nama', 't_log_kunci.created_at'];
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->from('t_log_kunci');	
		$this->db->join('m_user', 't_log_kunci.id_user = m_user.id', 'left');
		$this->db->where('t_log_kunci.deleted_at is null');
	...
	function get_datatable_log_kunci()
	{
