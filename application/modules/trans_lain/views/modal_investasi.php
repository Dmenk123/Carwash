            ...
            <div class="kt-portlet__body">
              <div class="form-group">       
                ...
                <div class="col-12 row">
                  ...
                  <label class="col-5 col-form-label">Nilai Total Investasi :</label>
                </div>

                <div class="col-12 row">
                  <div class="col-3">
                    <select class="form-control select2" id="tahun_inves" name="tahun_inves" style="width: 100%;">
                  ...
                  <div class="col-4">
                    <select class="form-control select2" id="bulan_inves" name="bulan_inves" style="width: 100%;">
