            ...
            <div class="kt-portlet__body">
              <div class="form-group">
                ...
                <div class="col-12 row">
                  <label class="col-8 col-form-label">Pembelian :</label>
                  <label class="col-4 col-form-label">Harga Total :</label>
                </div>
                <div class="col-12 row">
                  <div class="col-8">
          ...
          <div class="col-md-12">
            <div class="kt-portlet__body">
              <div class="form-group">
                ...
                <div class="col-12 row">
                  <div class="col-2">
                    <input type="number" class="form-control form-control-sm" id="qty_beli" name="qty_beli" value="">
                    <span class="help-block"></span>
                  </div>
                  <div class="col-5">
